...
# docker exec testnet2 stellar-core http-command peers | grep address > ips.txt
raw_data = [
...
os.system("docker exec testnet2 stellar-core http-command peers | grep address >> ipa.txt")
